  ...
  <input type="text" class="form-control" name="daterange" value="" aria-describedby="basic-addon1">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{isset($report->investment) ? number_format($report->investment) : 0}}</td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td><strong>Money Recycled</strong></td>
                                <td>{{isset($report->month_repayments) ? number_format($report->month_repayments) : 0}}</td>
                                <td></td>
                                <td></td>
                            </tr>
                            @endif
        ...
        <div class="col-sm-5">
            <div class="card">
                ...
                <div class="card-body card-padding">
                    <ul class="">
                        <li class=""><a href="{{route('performance.monthly', ['m' => '1'])}}">January</a></li>
                        <li><a href="{{route('performance.monthly', ['m' => '2'])}}">February</a></li>
                        <li><a href="{{route('performance.monthly', ['m' => '3'])}}">March</a></li>
                        <li><a href="{{route('performance.monthly', ['m' => '4'])}}">April</a></li>
                        <li><a href="{{route('performance.monthly', ['m' => '5'])}}">May</a></li>
                        <li><a href="{{route('performance.monthly', ['m' => '6'])}}">June</a></li>
                        <li><a href="{{route('performance.monthly', ['m' => '7'])}}">July</a></li>
                        <li><a href="{{route('performance.monthly', ['m' => '8'])}}">August</a></li>
                        <li><a href="{{route('performance.monthly', ['m' => '9'])}}">September</a></li>
                    </ul>
                </div>
            </div>
        </div>
