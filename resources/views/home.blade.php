...
<div class="section">
  ...
  <div class="col col-md-3 col-xs-6">
    <div class="wgt-plain">
      <span class="wgt-figure">{{isset($critical->accrued_int) ? number_format($critical->accrued_int) : 0}}</span>
      <div class="wgt-text"><span>Accrued Income (KSHs)</span></div>
    </div>
  </div>
...
<div class="row" style="padding-top: 30px; padding-bottom: 30px;">
  ...
  <div class="col col-md-3 col-xs-6">
    <div class="wgt-plain">
      <span class="wgt-figure">{{isset($critical->earning) ? number_format($critical->earning) : 0}}</span>
      <div class="wgt-text"><span>Paid Income (KSHs)</span></div>
    </div>
  </div>
